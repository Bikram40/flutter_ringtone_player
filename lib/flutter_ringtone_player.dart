...
class FlutterRingtonePlayer {
  ...
  static Future<void> stop({IosSound? ios}) async {
    try {
      var args = <String, dynamic>{};
      if (ios != null) args['ios'] = ios.value;
